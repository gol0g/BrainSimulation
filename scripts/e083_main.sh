#!/bin/bash
# E083: KC 경로 영향력 × KC 학습 — 2×2 요인설계.  ★E082를 대체한다
#
...
#       => **런별 원본 stdout 전량**을 logs/E083/ 에 파일로 남기고, 요약만 화면에 낸다.
# INV-B4(평가 중 가소성 동결)는 reset() 수정으로 확보됨. INV-A4/A5 명시.
set -u
R=/mnt/c/Users/JungHyun/Desktop/brain/BrainSimulation-rebuild
LOG="$R/research/experiments/E083.log"
RAW="$R/research/experiments/logs/E083"
mkdir -p "$RAW"
...
BASE="--d1-inhib -400 --direct-inhib -100 --epsilon 0.6 --bias 25 --bias-at-d1 --reflex-w 3 --episodes 60 --real-rstdp --crossed --kc-w-max 750"
