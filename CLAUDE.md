...
║      └── 랜덤 환경에서 효과 제한적 (Phase 3b보다 약간 낮음)  ║
║                                                               ║
║  4: 기저핵 - 습관 학습 ← 다음                                ║
║      └── 반복 행동 자동화, 절차 기억                         ║
╚═══════════════════════════════════════════════════════════════╝
...
### 현재 상태: Phase 3c 완료 (5,800 뉴런)

```
╔═══════════════════════════════════════════════════════════════╗
║  Phase 3c 결과 (Directional Food Memory)                      ║
╠═══════════════════════════════════════════════════════════════╣
║  생존율:        55% ✓ (목표: >40%)                            ║
║  Starve Death:  45%                                           ║
║  Pain Avoidance:95% ✓ (목표: <15% pain time)                  ║
║  뉴런 수:       5,800 (Hypo+Amyg+Hippo)                        ║
║  학습:          방향성 Hebbian 학습 (LEFT/RIGHT)              ║
║  참고:          랜덤 환경에서 Phase 3b(60%)보다 약간 낮음     ║
╚═══════════════════════════════════════════════════════════════╝
```
