...
║  M4: context rules sel=0.50 (6회 시도 실패, D1_ctx R-STDP 필요)  ║
║                                                               ║
...
| | | | | |
| **C0** | **개념 검증 프레임워크 (evaluate_concepts.py)** | **0** | **✓ 완료** | |
| **C0.5** | **SWR Selective Replay (tagged 경험 우선)** | **0** | **✓ 완료** | |
| **C1** | **Eligibility Bridge (sound→DA 시간 연결)** | **0** | **✓ 완료** | **70%** (단일KC) |
