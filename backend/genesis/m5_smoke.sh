...
python -u /mnt/c/Users/JungHyun/Desktop/brain/BrainSimulation/backend/genesis/test_context_m5_smoke.py 2>&1 | grep -iE "M5 smoke|sel=|shunt:|DONE|Error|Traceback" | head -20
echo "=== END ==="
