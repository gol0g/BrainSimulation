"""
Phase 2: Fast headless training (no visualization)
"""
import sys
...
print("=" * 60)
print("Phase 2: Fast Training (No Visualization)")
print("=" * 60)
...
if phase2_path.exists():
    brain.load(phase2_path)
    print("Resumed from phase2_best.pt")
